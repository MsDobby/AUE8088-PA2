...
class LoadImagesAndLabels(Dataset):
    ...
    def load_mosaic(self, index):
        ...
        for i, index in enumerate(indices):
            ...
            imgs, _, (shape1, shape2) = self.load_image(index)
            assert shape1 == shape2, "LWIR and RGB image should have same shape"
            h = shape1[0]
            w = shape1[1]
            ...
            if i == 0:  # top left
                ...
                img4 = np.full((s * 2, s * 2, imgs[0].shape[2]), 114, dtype=np.uint8)  # base image with 4 tiles
            ...
            img4[y1a:y2a, x1a:x2a] = imgs[0][y1b:y2b, x1b:x2b]  # img4[ymin:ymax, xmin:xmax]
            padw = x1a - x1b
            padh = y1a - y1b
